...
Shader "SimpleURPToonLitExample(With Outline)"
{
    ...
    SubShader
    {
        Tags
        {
            ...
            // explict SubShader tag to avoid confusion "RenderType" = "Opaque"
        ...
        Pass
        {
            ...
            Tags
            {
                ...
                // "Lightmode" tag must be "UniversalForward" in order to render lit objects in URP. "LightMode" = "UniversalForward"
            }
